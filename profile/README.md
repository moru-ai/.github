...
- [Maru](https://github.com/moru-ai/maru): A web clone of Claude Code built with Moru sandboxes and [Claude Agent SDK](https://platform.claude.com/docs/en/agent-sdk/overview)
